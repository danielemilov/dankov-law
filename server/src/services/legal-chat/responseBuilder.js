...
export function buildResponse({ classification, entities, urgency, state }) {
  ...
  if (classification.intent === 'unknown') {
    return {
      reply: withDisclaimer('За да ви насоча правилно, напишете с едно-две изречения какво се случи, кога стана и с кого е свързан проблемът. Ако има срок, акт, заповед, съд, полиция или работодател, споменете го.'),
      state,
      shouldShowContactForm: false,
      priority: 'normal',
    };
