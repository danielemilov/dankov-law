...
export default function HeroScene3D() {
  ...
  useEffect(() => {
    ...
    const goldLight = new THREE.PointLight(0xe4bf74, 1.8, 8.5);
    ...
    const resize = () => {
      ...
      const portraitCard = width < 700 || aspect < 1.08;
      ...
      if (compact) {
        ...
        stage.position.set(0.1, 0.14, 0);
        stage.scale.setScalar(0.98);
        scales.rotation.set(-0.035, -0.24, 0);
      }
    };
