...
const navLinks = [
  {
    ...
    href: '#about',
    eyebrow: 'Профил',
    description: 'Подход, опит и позиция.',
    Icon: UserRound,
  },
  {
    label: 'Казуси',
    href: '#cases',
    eyebrow: 'Практика',
    description: 'Реални ситуации и защита.',
  ...
  },
  {
    ...
    href: '#video',
    eyebrow: 'Истории',
    description: 'Кратки правни насоки.',
    Icon: Clapperboard,
  },
  {
    label: 'Контакт',
    href: '#contact',
    eyebrow: 'Разград',
    description: 'Адрес и заявка за час.',
    Icon: MapPin,
  },
];
          ...
          >
            ...
            >
              ...
              <div className="navPrimeMobile__intro">
                <span className="navPrimeMobile__mark">
                  <Scale size={18} strokeWidth={2.1} />
                </span>
                <div>
                  <p>Меню</p>
              ...
              <nav className="navPrimeMobile__links" aria-label="Мобилна навигация">
                {navLinks.map((link, index) => (
                  ...
                  >
                    <span className="navPrimeMobile__icon" aria-hidden="true">
                      <link.Icon size={19} strokeWidth={2.1} />
                    </span>
                    ...
                    <span className="navPrimeMobile__arrow" aria-hidden="true">
              ...
              <a className="navPrimeMobile__cta" href="#contact" onClick={closeMenu}>
                Запази консултация <ArrowUpRight size={18} strokeWidth={2.2} />
              </a>
            </motion.div>
          </motion.div>
        )}
