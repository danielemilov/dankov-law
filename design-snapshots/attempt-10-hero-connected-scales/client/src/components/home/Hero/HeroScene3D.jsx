...
export default function HeroScene3D() {
  ...
  useEffect(() => {
    ...
    const column = makeCylinder(0.055, 0.075, 2.72, goldMaterial, 72);
    column.position.y = -0.18;
    scales.add(column);

    const base = makeCylinder(0.52, 0.7, 0.11, darkGoldMaterial, 96);
    base.position.y = -1.62;
    base.scale.z = 0.58;
    scales.add(base);

    const baseLine = makeRing(0.66, 0.01, beamGlowMaterial);
    baseLine.rotation.x = Math.PI / 2;
    baseLine.scale.z = 0.58;
